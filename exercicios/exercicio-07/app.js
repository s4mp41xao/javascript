...
- As primeiras 4 strings são ${firstFourStrings.join(`, `).replace(`, ${lastItem}`,` e ${lastItem}`)};
...
switch (drinkType) {
  case 'água':
    drinkMessage = 'Substânciaquímica cujas moléculas são formadas por dois átomos de hidrogênio e um de oxigênio.'
    break
  case 'refrigerante':
