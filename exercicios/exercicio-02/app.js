...
// const myFavoriteTom = `Nome: ${tom}, Sobrenome: ${secondTom}`
...
const programmingLanguage = 'JavaScript'
// const j = programmingLanguage[0]
// const s = programmingLanguage[4]
// const js = j + s
...
// const indexM = mozilla.slice(0, 1)
// const indexD = mozilla.slice(8, 9)
// const indexN = mozilla.slice(18, 19)
// const mdn = indexM + indexD + indexN
// console.log(mdn)

const mozilla = 'Mozilla Developer Network'
const mdn = mozilla[0] + mozilla[8] + mozilla[18]
// console.log(mdn)
// console.log(mozilla[1], mozilla[9], mozilla[19])
...
// const lowerCase = summerMessage.toLowerCase()
...
// const upperName = name.slice(0, 6).replace('w', 'W')
// const upperSobrenome = name.slice(7, 12).replace('w', 'W')
// let newName = upperName + ' ' + upperSobrenome
